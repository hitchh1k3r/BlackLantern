...
// Nodes ///////////////////////////////////////////////////////////////////////////////////////////
  ...
  NodeSerial :: struct {
    ...
    using _ : bit_field u32 { // 15 17
      ...
      min_action : ActionId | 7, // 0-127
      action_count : u8 | 3,     // 0-7
  ...
  init_nodes :: proc "contextless" () {
        ...
        // Dream 3
          ...
          // Outside
            ...
            .Dream3_Fears_Spoon = {
              ...
              up = { 0.000000, 1.000000, 0.000000 },
              size = 0.400000,
              actions = action_range(.Dream3_Fears_Spoon_Stir, .Dream3_Fears_Spoon_Stir),
            },
            .Dream3_Fears_Slide = {
              disabled = true,
              name = "Photo Slide",
              ...
              up = { 0.000000, 1.000000, 0.000000 },
              size = 0.400000,
              actions = action_range(.Dream3_Fears_Slide_Project, .Dream3_Fears_Slide_Project),
            },
            .Dream3_Fears_Ball = {
              disabled = true,
              name = "Toy Ball",
              ...
              up = { 0.000000, 1.000000, 0.000000 },
              size = 0.400000,
              actions = action_range(.Dream3_Fears_Ball_Throw, .Dream3_Fears_Ball_Throw),
            },
          // The End
            .Dream3_TheEnd_Bed = {
              disabled = true,
    ...
    */
    ...
    // NODES: (3.681 KB - 28.31%)
    // ACTIONS: (2.432 KB - 18.70%)
    NODE_DATA := [NodeId]NodeSerial{
      // ChildsRoom
        // Floor
          .ChildsRoom_Floor_Bed = {
            name = "Bed",
            ...
            distance = 1,
            rotation = 1,
            min_action = .ChildsRoom_Floor_Bed_Smell,
            action_count = 4,
          },
      ...
      // Memory 1
        .Memory1_Bounce = {
          ...
          disabled = false,
          center = true,
          sense_left_until_revealed = 0,
          yaw_pos = 0,
          pitch_pos = 2,
          distance = 1,
          rotation = 1,
          min_action = .Memory1_Bounce_Remember,
          action_count = 1,
        },
        .Memory1_Laugh = {
          name = "Lauge",
          ...
          distance = 1,
          rotation = 1,
          min_action = .Memory1_Laugh_Remember,
          action_count = 1,
        },
        .Memory1_Touch = {
          name = "Touch",
          ...
          distance = 1,
          rotation = 1,
          min_action = .Memory1_Touch_Remember,
          action_count = 1,
        },
        .Memory1_Home = {
          name = "Home",
          ...
          distance = 1,
          rotation = 1,
          min_action = .Memory1_Home_Remember,
          action_count = 1,
        },
      ...
      // Memory 2
        .Memory2_Lamp = {
          ...
          distance = 1,
          rotation = 1,
          min_action = .Memory2_Lamp_Remember,
          action_count = 1,
        },
        .Memory2_Light = {
          name = "Light",
          ...
          distance = 1,
          rotation = 1,
          min_action = .Memory2_Light_Remember,
          action_count = 1,
        },
        .Memory2_Flash = {
          name = "Flash",
          ...
          distance = 1,
          rotation = 1,
          min_action = .Memory2_Flash_Remember,
          action_count = 1,
        },
        .Memory2_Dark = {
          name = "Dark",
          ...
          distance = 1,
          rotation = 1,
          min_action = .Memory2_Dark_Remember,
          action_count = 1,
        },
        .Memory2_Listen = {
          name = "Listen",
          ...
          distance = 1,
          rotation = 1,
          min_action = .Memory2_Listen_Remember,
          action_count = 1,
        },
      ...
      // Memory 3
        .Memory3_Stir = {
          ...
          distance = 1,
          rotation = 1,
          min_action = .Memory3_Stir_Remember,
          action_count = 1,
        },
        .Memory3_Voice = {
          name = "Voice",
          ...
          distance = 1,
          rotation = 1,
          min_action = .Memory3_Voice_Remember,
          action_count = 1,
        },
        .Memory3_Siren = {
          name = "Siren",
          ...
          distance = 1,
          rotation = 1,
          min_action = .Memory3_Siren_Remember,
          action_count = 1,
        },
        .Memory3_Ache = {
          name = "Ache",
          ...
          distance = 1,
          rotation = 1,
          min_action = .Memory3_Ache_Remember,
          action_count = 1,
        },
      ...
      // Dream 3
        // House
          .Dream3_House_Table = {
            ...
            distance = 1,
            rotation = 1,
            min_action = .Dream3_House_Table_Climb,
            action_count = 1,
          },
          .Dream3_House_Chair = {
            name = "Chair",
            ...
            distance = 1,
            rotation = 1,
            min_action = .Dream3_House_Chair_Scratch,
            action_count = 1,
          },
          .Dream3_House_Window = {
            name = "Window",
            ...
            distance = 1,
            rotation = 1,
            min_action = .Dream3_House_Window_Look,
            action_count = 1,
          },
          .Dream3_House_Door = {
            name = "Door",
            ...
            distance = 1,
            rotation = 1,
            min_action = .Dream3_House_Door_Push,
            action_count = 1,
          },
          .Dream3_House_Outside = {
            name = "Outside",
            ...
            distance = 1,
            rotation = 1,
            min_action = .Dream3_House_Outside_MoveTo,
            action_count = 1,
          },
        // Outside
          .Dream3_Fears_Insignificance = {
          ...
          .Dream3_Outside_Tree = {
            ...
            distance = 1,
            rotation = 1,
            min_action = .Dream3_Outside_Tree_Scratch,
            action_count = 1,
          },
          .Dream3_Outside_Street = {
            name = "Street",
            ...
            distance = 1,
            rotation = 1,
            min_action = .Dream3_Outside_Street_Listen,
            action_count = 1,
          },
          .Dream3_Outside_Moon = {
            name = "Moon",
            ...
            distance = 1,
            rotation = 1,
            min_action = .Dream3_Outside_Moon_Call,
            action_count = 1,
          },
          .Dream3_Fears_Spoon = {
            name = "Spoon",
            ...
            distance = 1,
            rotation = 1,
            min_action = .Dream3_Fears_Spoon_Stir,
            action_count = 1,
          },
          .Dream3_Fears_Slide = {
            name = "Slide",
            ...
            distance = 1,
            rotation = 1,
            min_action = .Dream3_Fears_Slide_Project,
            action_count = 1,
          },
          .Dream3_Fears_Ball = {
            name = "Ball",
            ...
            distance = 1,
            rotation = 1,
            min_action = .Dream3_Fears_Ball_Throw,
            action_count = 1,
          },
          .Dream3_TheEnd_Bed = {
            name = "Bed",
            ...
            distance = 1,
            rotation = 1,
            min_action = .Dream3_TheEnd_Bed_Rest,
            action_count = 1,
          },
      ...
      // Credits
        .Credits_Made = {
          ...
          distance = 1,
          rotation = 1,
          min_action = .Credits_Made_ByHitchh1k3r,
          action_count = 3,
        },
        .Credits_Thanks = {
          name = "Thanks\nFor\nPlaying!",
    ...
    for serial, key in NODE_DATA {
      ...
      pitch := (f32(serial.pitch_pos)-2) * 20 * RAD_PER_DEG
      if pitch > 0 {
        pitch /= 2
      }
      transform := mat4_yaw_pitch(yaw, pitch)
      node.pos = (transform * V4{ 0, 0, f32(u8(1 << serial.distance)), 1 }).xyz
      transform *= mat4_yaw_pitch((f32(serial.rotation)-1) * 35 * RAD_PER_DEG, 0)
      node.right = (transform * V4{ 1, 0, 0, 0 }).xyz
      node.up = (transform * V4{ 0, 1, 0, 0 }).xyz
      node.size = 0.4
      node.actions = (transmute([^]Action)(&action_mem))[int(serial.min_action):int(serial.min_action)+int(serial.action_count)]
      node_mem[key] = node
    }
  }
...
// Actions /////////////////////////////////////////////////////////////////////////////////////////
  ...
  ActionId :: enum u8 {
    ...
    Dream3_Fears_Spoon_Stir,
    Dream3_Fears_Slide_Project,
    Dream3_Fears_Ball_Throw,
